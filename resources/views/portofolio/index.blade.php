@extends('portofolio.layouts.main')
...
<!-- works
================================================== -->
<section id="articles" class="s-works target-section">
    ...
    <div class="masonry-wrap">
        ...
        <div class="masonry">
            ...
            <div class="masonry__brick" data-aos="fade-up">
                <div class="item-folio">
                    ...
                    <div class="item-folio__thumb">
                        <a href="/portofolio/images/portfolio/gallery/g-city-building.jpg" class="thumb-link" title="Shutterbug" data-size="1050x700">
                            <img src="https://source.unsplash.com/1200x500?{{ $post->category->name }}" alt="">
                        </a>    
                        <a href="/posts/{{ $post->slug }}" class="item-folio__project-link" title="Project link" target="_blank"></a>
                    </div>
            ...
            {{-- <div class="masonry__brick" data-aos="fade-up">
                <div class="item-folio">
                    <div class="item-folio__thumb">
                        <a href="/portofolio/images/portfolio/gallery/g-woodcraft.jpg" class="thumb-link" title="Woodcraft" data-size="1050x700">
                            <img src="/portofolio/images/portfolio/woodcraft.jpg" 
                                    srcset="/portofolio/images/portfolio/woodcraft.jpg 1x, /portofolio/images/portfolio/woodcraft@2x.jpg 2x" alt="">
                        </a>
            ...
            <div class="masonry__brick" data-aos="fade-up">
                <div class="item-folio">
                    ...
                    <div class="item-folio__thumb">
                        <a href="/portofolio/images/portfolio/gallery/g-beetle.jpg" class="thumb-link" title="The Beetle Car" data-size="1050x700">
                            <img src="/portofolio/images/portfolio/the-beetle.jpg"
                                    srcset="/portofolio/images/portfolio/the-beetle.jpg 1x, /portofolio/images/portfolio/the-beetle@2x.jpg 2x" alt="">
                        </a>
                        <a href="https://www.behance.net/" class="item-folio__project-link" title="Project link" target="_blank"></a>
                    </div>
                    <div class="item-folio__text">
            ...
            <div class="masonry__brick" data-aos="fade-up">
                <div class="item-folio">
                    <div class="item-folio__thumb">
                        <a href="/portofolio/images/portfolio/gallery/g-shutterbug.jpg" class="thumb-link" title="Grow Green" data-size="1050x700">
                            <img src="/portofolio/images/portfolio/shutterbug.jpg" 
                                    srcset="/portofolio/images/portfolio/shutterbug.jpg 1x, /portofolio/images/portfolio/shutterbug@2x.jpg 2x" alt="">
                        </a>
                        <a href="https://www.behance.net/" class="item-folio__project-link" title="Project link" target="_blank"></a>
                    </div>
                    <div class="item-folio__text">
            ...
            <div class="masonry__brick" data-aos="fade-up">
                <div class="item-folio">
                    ...
                    <div class="item-folio__thumb">
                        <a href="/portofolio/images/portfolio/gallery/g-lamp.jpg" class="thumb-link" title="Guitarist" data-size="1050x700">
                            <img src="/portofolio/images/portfolio/lamp.jpg" 
                                    srcset="/portofolio/images/portfolio/lamp.jpg 1x, /portofolio/images/portfolio/lamp@2x.jpg 2x" alt="">
                        </a>
                        <a href="https://www.behance.net/" class="item-folio__project-link" title="Project link" target="_blank"></a>
                    </div>
                    <div class="item-folio__text">
            ...
            <div class="masonry__brick" data-aos="fade-up">
                <div class="item-folio">
                    ...
                    <div class="item-folio__thumb">
                        <a href="/portofolio/images/portfolio/gallery/g-fuji.jpg" class="thumb-link" title="Palmeira" data-size="1050x700">
                            <img src="/portofolio/images/portfolio/fuji.jpg"
                                    srcset="/portofolio/images/portfolio/fuji.jpg 1x, /portofolio/images/portfolio/fuji@2x.jpg 2x" alt="">
                        </a>
                        <a href="https://www.behance.net/" class="item-folio__project-link" title="Project link" target="_blank"></a>
                    </div>
                    <div class="item-folio__text">
        ...
        <div class="column large-full testimonials__slider">
            ...
            <div class="testimonials__slide">
                ...
                <div class="testimonials__info">
                    <img src="/portofolio/images/avatars/user-02.jpg" alt="Author image" class="testimonials__avatar">
            ...
            <div class="testimonials__slide">
                ...
                <div class="testimonials__info">
                    <img src="/portofolio/images/avatars/user-01.jpg" alt="Author image" class="testimonials__avatar">
                    <cite class="testimonials__cite">
            ...
            <div class="testimonials__slide">
                ...
                <div class="testimonials__info">
                    <img src="/portofolio/images/avatars/user-04.jpg" alt="Author image" class="testimonials__avatar">
                    <cite class="testimonials__cite">
...
<section id="contact" class="s-contact ss-dark target-section">
    ...
    <div class="row contact-main" data-aos="fade-up">
        <div class="column large-full">
            <p class="contact-email">
                <a href="mailto:frimasatria347@gmail.com">frimasatria347@gmail.com</a>
            </p>

            <p class="section-desc">
            I'm happy to connect, listen and help. Let's work together and build
            something awesome. Let's turn your idea to an even greater product.
            <a href="mailto:frimasatria347@gmail.com">Email Me</a>.
            </p>
        </div>
    </div>
    ...
    <div class="row contact-infos" data-aos="fade-up" data-aos-anchor=".contact-main">
        ...
        <div class="column large-5 medium-full contact-phone">
            <h4>Call Me</h4>
            <a href="tel:085161331197">+62 851-6133-1197</a>
        </div>
